"""
Helper module for generating self-signed SSL certificates for local development.
"""
...
def generate_self_signed_cert(cert_dir="certs", days_valid=365):
    ...
    subject = issuer = x509.Name(
        [
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "CasaPAT Dev"),
            x509.NameAttribute(NameOID.COMMON_NAME, "pat.local"),
        ]
    )
